...
import org.example.springboot.service.DashboardStatsService;
...
public class IndexController {
    ...
    /**
     * 获取仪表板统计数据
     * 提供管理后台Dashboard所需的各项统计数据
     *
     * @return 返回统计数据
     */
    @Tag(name = "仪表板管理", description = "仪表板统计数据接口")
    @Operation(summary = "获取仪表板统计数据")
    @GetMapping("/api/dashboard/stats")
    @ResponseBody
    public Result<DashboardStatsResponseDTO> getDashboardStats() {
        log.info("获取仪表板统计数据");
